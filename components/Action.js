...
const Action = () => {
    const handleBuildPriceClick = () => {
      ...
      const handleContactDealerClick = () => {
        window.location.href = '/contact-dealer'; 
      };
    
return <section>
    <section className={styles.action}>
    <Heading level={2} textAlign="center" padding-top={2} color="white">Get Behind the Wheel</Heading>
  <p className={styles.action__call}>Start customizing your Impreza today, or contact your local Subaru dealer to experience one in person.</p>
